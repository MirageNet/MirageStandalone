...
namespace Mirage
{
    ...
    public class NetworkSceneManager : MonoBehaviour//, INetworkSceneManager
    {
        ...
        //[SerializeField] 
        //SceneChangeEvent _onClientStartedSceneChange = new SceneChangeEvent();

        //[FormerlySerializedAs("ClientSceneChanged")]
        //[SerializeField] 
        //SceneChangeEvent _onClientFinishedSceneChange = new SceneChangeEvent();

        //[FormerlySerializedAs("ServerChangeScene")]
        //[SerializeField] 
        //SceneChangeEvent _onServerStartedSceneChange = new SceneChangeEvent();

        //[FormerlySerializedAs("ServerSceneChanged")]
        //[SerializeField] 
        //SceneChangeEvent _onServerFinishedSceneChange = new SceneChangeEvent();

        //[SerializeField] 
        //PlayerSceneChangeEvent _onPlayerSceneReady = new PlayerSceneChangeEvent();

        /// <summary>
        /// Event fires when the Client starts changing scene.
        /// </summary>
        public Action<string, SceneOperation> OnClientStartedSceneChange { get; set; }

        /// <summary>
        /// Event fires after the Client has completed its scene change.
        /// </summary>
        public Action<string, SceneOperation> OnClientFinishedSceneChange { get; set; }

        /// <summary>
        /// Event fires before Server changes scene.
        /// </summary>
        public Action<string, SceneOperation> OnServerStartedSceneChange { get; set; }

        /// <summary>
        /// Event fires after Server has completed scene change.
        /// </summary>
        public Action<string, SceneOperation> OnServerFinishedSceneChange { get; set; }

        /// <summary>
        /// Event fires On the server, after Client sends <see cref="SceneReadyMessage"/> to the server
        /// </summary>
        public Action<INetworkPlayer> OnPlayerSceneReady { get; set; }
        ...
        public virtual void Start()
        {
            ...
            if (Client != null)
                Client.Started += RegisterClientMessages;

            if (Server != null)
            {
                Server.Started += RegisterServerMessages;
                Server.Authenticated += OnServerAuthenticated;
                Server.Disconnected += OnServerPlayerDisconnected;
            }
        }
        ...
        public virtual void ClientStartSceneMessage(INetworkPlayer player, SceneMessage message)
        {
            ...
            if (message.AdditiveScenes != null && message.AdditiveScenes.Count > 0 && Client != null && !Client.IsLocalClient)
            {
            ...
            //LoadSceneAsync(message.MainActivateScene, new[] { player }, message.SceneOperation);
        }
        ...
        {
            if (ClientPendingAdditiveSceneLoadingList.Count > 0 && Client != null && !Client.IsLocalClient)
            {
                ...
                //LoadSceneAsync(ClientPendingAdditiveSceneLoadingList[0], new[] { Client.Player }, SceneOperation.LoadAdditive);
            ...
            bool shouldClientLoadOrUnloadNormally, SceneOperation sceneOperation = SceneOperation.Normal)
        {
            ...
            //    LoadSceneAsync(scenePath, players, sceneOperation);
        ...
        private void ServerSceneUnLoading(Scene scene, IEnumerable<INetworkPlayer> players)
        {
            ...
            // if not host
            //if (!Server.LocalClientActive)
            //    UnLoadSceneAsync(scene, SceneOperation.UnloadAdditive);
        ...
        {
            var additiveScenes = new List<string>(0);// SceneManager.sceneCount - 1);
        ...
        internal void CompleteLoadingScene(string scenePath, SceneOperation sceneOperation)
        {
            ...
            if (Server != null && Server.Active)
            {
                ...
                Scene scene = new Scene();// SceneManager.GetSceneAt(SceneManager.sceneCount - 1);
        ...
        ///// <param name="sceneOperation">Choose type of scene loading we are doing <see cref="SceneOperation"/>.</param>
        ///// <returns></returns>
        //private Task UnLoadSceneAsync(Scene scenePath, SceneOperation sceneOperation)
        //{
        ...
        ///// <param name="sceneOperation">Choose type of scene loading we are doing <see cref="SceneOperation"/>.</param>
        //private Task LoadSceneAsync(string scenePath, IEnumerable<INetworkPlayer> players, SceneOperation sceneOperation = SceneOperation.Normal)
        //{
        //    switch (sceneOperation)
        //    {
        ...
        ///// </summary>
        ///// <param name="scenePath">The full path to the scene file or the name of the scene.</param>
        //private async Task LoadSceneNormalAsync(string scenePath)
        //{
        ...
        //        if (Client != null && Client.Active && !Client.IsLocalClient)
        //        {
        ...
        //private async Task LoadSceneAdditiveAsync(string scenePath, IEnumerable<INetworkPlayer> players)
        //{
        ...
        ///// <param name="scenePath">The full path to the scene file or the name of the scene.</param>
        ///// <returns></returns>
        //private async Task UnLoadSceneAdditiveAsync(string scenePath)
        //{
        ...
        //private async Task UnLoadSceneAdditiveAsync(Scene scene)
        //{
        //    // Ensure additive scene is actually loaded
        //    if (scene.IsValid())
        //    {
