    ...
    public class CharacterSpawner : MonoBehaviour
    {
        ...
        public virtual void Awake()
        {
            ...
            if (Client != null)
            {
                ...
                {
                    SceneManager.OnClientFinishedSceneChange += OnClientFinishedSceneChange;
                }
                else
                {
                    Client.Authenticated += OnClientAuthenticated;
                }
        ...
        public virtual void OnServerAddPlayer(INetworkPlayer player)
        {
            ...
            //TODO: NetworkIdentity character = startPos != null
