...
//    {
//        /// <summary>
//        /// Gets <see cref="NetworkIdentity"/> on a <see cref="Unity"/> and throws <see cref="InvalidOperationException"/> if the GameObject does not have one.
//        /// </summary>
...
//        public static NetworkIdentity GetNetworkIdentity(this Unity gameObject)
//        {
...
//        /// <returns></returns>
//        public void ReplaceCharacter(INetworkPlayer player, Unity character, Guid assetId, bool keepAuthority = false)
//        {
...
//        /// <param name="keepAuthority">Does the previous player remain attached to this connection?</param>
//        /// <returns></returns>
//        public void ReplaceCharacter(INetworkPlayer player, Unity character, bool keepAuthority = false)
//        {
//            NetworkIdentity identity = character.GetNetworkIdentity();
//            ReplaceCharacter(player, identity, keepAuthority);
//        }
...
//        /// <param name="assetId"></param>
//        /// <returns></returns>
//        public void AddCharacter(INetworkPlayer player, Unity character, Guid assetId)
//        {
//            NetworkIdentity identity = character.GetNetworkIdentity();
//            identity.AssetId = assetId;
...
//        public void AddCharacter(INetworkPlayer player, Unity character)
//        {
//            NetworkIdentity identity = character.GetNetworkIdentity();
//            AddCharacter(player, identity);
//        }
...
//        public void Spawn(Unity obj, Unity ownerObject)
//        {
...
//        public void Spawn(Unity obj, Guid assetId, INetworkPlayer owner = null)
//        {
...
//        /// </summary>
//        public void Spawn(Unity obj, INetworkPlayer owner = null)
//        {
//            NetworkIdentity identity = obj.GetNetworkIdentity();
//            Spawn(identity, owner);
//        }
...
//        static void ThrowIfPrefab(Unity obj)
//        {
//#if UNITY_EDITOR
...
//        /// </summary>
//        public void Destroy(Unity gameObject, bool destroyServerObject = true)
//        {
//            if (gameObject == null)
//            {
